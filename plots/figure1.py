...
# Read human data
human_df = pd.read_csv('./auction_human.csv')

# Read LLM data (use updated results with corrected CV calculations)
llm_df = pd.read_csv('./theoretical_deviation_results_updated.csv')
...
summary_csv_path = Path('./human_llm_comparison_summary.csv')
