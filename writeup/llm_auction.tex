...
In both the FPSB and SPSB auction (and indeed, almost all auctions) there is robust evidence of bids being strictly monotone in one's value. \TK{Add citations and summary of the experiments}
...
We developed a scale and applied to ... The sample size is... Give a clarification of the scales, attaching an example for all the scales.

Reduce to 2 scale:
1. Risk-averse 
2. familiarity of the auction format.
