...
In Fig \ref{fig:cross}, we plotted the bidding behavior of LLM agents in two different auction formats: First-Price and Second-Price auctions. 
...
\begin{figure}[h]
    \centering \includegraphics[width=0.75\linewidth]{Figs/cross-format.png}
