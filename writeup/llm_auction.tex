...
\begin{lstlisting}[basicstyle=\ttfamily]
    ...
    Your TOP PRIORITY is to place bids which maximize 
    the user's profit in the long run. To do this, you should explore many different bidding strategies, 
    ...
    In this game, you will participate in an auction for a prize against 2 other bidders. 
    At the start of each round, bidders will see their value for the prize, 
    randomly drawn between \$0 and \$99, with all values equally likely. 
    After learning your value, 
    you will submit a bid privately at the same time as the other bidders. 
    Bids must be between \$0 and \$99 in \$1 increments. 
    The highest bidder wins the prize and pays their bid amount. 
    This means that, if you win, 
    we will add to your earnings the value for the prize, 
    and subtract from your earnings your bid. 
    If you don't win, your earnings remain unchanged. 
    After each auction, we will display all bids and profits. 
    Ties for the highest bid will be resolved randomly. 
...
The previous round history is: last_round 
...
\begin{quote}
\begin{lstlisting}[basicstyle=\ttfamily]
The previous round histories along with your plans are: {HISTORY}
After careful reflection on previous bidding,
your analysis for last round is 
{REFLECTION}. 
...
\avs{Hi John! Your feedback here would be very useful. 
...
primarily putting forward a framework on how to think about LLM experimental agents as proxy for human agents.
 ...
 \avs{John: should we make the conclusion more punchy?}
