...
% - Known co-author decisions pending: (i) \ifanon build does not scrub the
%   open-source-release sentence in intro P9 or the Disclosure paragraph below;
...
\input{contents_v2/00_abstract}

\newpage

\input{contents_v2/01_intro}
\input{contents_v2/02_related}
\input{contents_v2/03_framework}
\input{contents_v2/04_design}
\input{contents_v2/05_validation}
\input{contents_v2/06_ranking}
\input{contents_v2/07_humans}
\input{contents_v2/08_discussion}
\input{contents_v2/09_conclusion}
...
\newpage
\appendix
\input{contents_v2/appendix_human}
\input{contents_v2/appendix_procedures}
\input{contents_v2/appendix_learning}
\input{contents_v2/appendix_ablations}
\input{contents_v2/appendix_prospect}
\input{contents_v2/appendix_prompts}
\input{contents_v2/appendix_traces}
\input{contents_v2/appendix_da}
\input{contents_v2/appendix_ebay}
