...
\paragraph{Iterative DA, binary-offer query.} The primary prompt at the binary-offer nodes of the OSP decision tree (Algorithm~\ref{alg:osp-da} in Appendix~\ref{app:da}); it explicitly states the consequence of each answer, providing the ``obviousness witness'' of \citet{ashlagi2018stable}:
