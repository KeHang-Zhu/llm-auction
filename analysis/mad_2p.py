...
file_paths = [
"/Users/wonderland/Desktop/auction/llm-auction/experiment_logs/seal_ascend_second_common_open/result_10_2024-05-27_14-16-59.json",
]
rounds, ave_mad_values = calculate_average_mad(file_paths)

# Plot Mean Absolute Deviation of Bids from Values vs Round
plt.plot(rounds, ave_mad_values, marker='o', linestyle='-', color='blue')
